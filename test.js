...
// enviroment renderering
{
    ...
    barracks.load('resources/Enviroment/Barracks.glb', function (gltf) {
        ...
        var boxBarracks1 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
    ...
    barracks.load('resources/Enviroment/Barracks.glb', function (gltf) {
        var model = gltf.scene;
        model.position.set(20, 0, -27);
        model.castShadow = true;
        model.receiveShadow = true;
        model.rotation.set(0, 31, 0);
        model.scale.set(6, 6, 6);
        Main.scene.add(model);
        var boxBarracks2 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    cottage.load('resources/Enviroment/Cottage.glb', function (gltf) {
        ...
        Main.scene.add(model);
        var boxCottage1 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    cottage2.load('resources/Enviroment/Cottage.glb', function (gltf) {
        ...
        model.scale.set(15, 15, 15);
        Main.scene.add(model);
        var boxCottage2 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    cottage3.load('resources/Enviroment/Cottage.glb', function (gltf) {
        ...
        model.scale.set(15, 15, 15);
        Main.scene.add(model);
        var boxCottage3 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    prairie.load('resources/Enviroment/Prairie Shed.glb', function (gltf) {
        ...
        Main.scene.add(model);
        var boxPrairie1 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    prairie.load('resources/Enviroment/Prairie Shed.glb', function (gltf) {
        var model = gltf.scene;
        model.position.set(-15, 2, 18);
        model.castShadow = true;
        model.receiveShadow = true;
        model.rotation.set(0, 10, 0);
        model.scale.set(2, 2, 2);
        Main.scene.add(model);
        var boxPrairie2 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    prairie.load('resources/Enviroment/Prairie Shed.glb', function (gltf) {
        var model = gltf.scene;
        model.position.set(16, 2, -18);
        model.castShadow = true;
        model.receiveShadow = true;
        model.rotation.set(0, 10, 0);
        model.scale.set(2, 2, 2);
        Main.scene.add(model);
        var boxPrairie3 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
...
{// TREE Static
    ...
    pine_tree.load('resources/Enviroment/Pine Tree.glb', function (gltf) {
        var model = gltf.scene;
        model.position.set(0, 3, 7);
        model.castShadow = true;
        model.receiveShadow = true;
        model.rotation.set(0, -Math.PI / 2.3, 0);
        model.scale.set(2, 2, 2);
        Main.scene.add(model);
        var boxTree1 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    pine_tree.load('resources/Enviroment/Pine Tree.glb', function (gltf) {
        var model = gltf.scene;
        model.position.set(15, 3, 7);
        model.castShadow = true;
        model.receiveShadow = true;
        model.rotation.set(0, -Math.PI / 2.3, 0);
        model.scale.set(2, 2, 2);
        Main.scene.add(model);
        var boxTree2 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    pine_tree.load('resources/Enviroment/Pine Tree.glb', function (gltf) {
        ...
        model.scale.set(2, 2, 2);
        Main.scene.add(model);
        var boxTree3 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    pine_tree.load('resources/Enviroment/Pine Tree.glb', function (gltf) {
        ...
        model.scale.set(2, 2, 2);
        Main.scene.add(model);
        var boxTree4 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
    ...
    pine_tree.load('resources/Enviroment/Pine Tree.glb', function (gltf) {
        var model = gltf.scene;
        model.position.set(6, 3, 19);
        model.castShadow = true;
        model.receiveShadow = true;
        model.rotation.set(0, -Math.PI / 2.3, 0);
        model.scale.set(2, 2, 2);
        Main.scene.add(model);
        var boxTree5 = new THREE.Box3().setFromObject(model);
        var helper = new THREE.BoxHelper(model, 0xffff00);
        Main.scene.add(helper);
    }, undefined, function (error) {
        console.error(error);
